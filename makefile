...
INCL_FILES += $(shell find $(RTOS_SRC_INCL_DIR) -type f -name "*.h")
...
# Board Files
INCL_FILES+=$(ARM_PACK_DIR)/Keil/Kinetis_KWxx_DFP/1.7.0/Device/Include/MKW41Z4.h

# Middleware Files
MID_FILES=$(ARM_PACK_DIR)/Keil/MDK-Middleware/7.4.1/Board

INCL_FILES += $(shell find $(MID_FILES) -type f -name "*.h")
